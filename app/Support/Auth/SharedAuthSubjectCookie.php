...
class SharedAuthSubjectCookie
{
    ...
    {
        return trim((string) config('services.keycloak.shared_subject_cookie', 'kanggo_active_subject'));
    }
    ...
    private static function makeCookie(Request $request, string $value): HttpCookie
    {
        return Cookie::make(
            self::name(),
            $value,

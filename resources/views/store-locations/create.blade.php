...
<div class="card store-location-modal">
    ...
    <style>
        ...
        .store-location-modal .store-location-store-caption {
            font-size: 11px;
            font-weight: 700;
    ...
    @php
        ...
        $storeRouteParams = [$store];
        if (filled($postRedirectUrl)) {
            $storeRouteParams['_redirect_url'] = $postRedirectUrl;
        }
        if (filled($postRedirectToMaterials)) {
            $storeRouteParams['_redirect_to_materials'] = $postRedirectToMaterials;
        }
    @endphp

    <form action="{{ route('store-locations.store', $storeRouteParams) }}" method="POST" class="store-location-form">
        @csrf
        @if(filled($postRedirectUrl))
        ...
        <div class="store-location-store-banner">
            <div class="store-location-store-caption">Toko</div>

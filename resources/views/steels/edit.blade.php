<div class="card">
    ...
    <form action="{{ route('steels.update', $steel->id) }}" method="POST" enctype="multipart/form-data" id="steelForm">
        @csrf
        @method('PUT')

        <input type="hidden" name="material_name" id="material_name" value="{{ old('material_name', $steel->material_name) }}">
        <input type="hidden" name="package_volume" id="package_volume" value="{{ old('package_volume', $steel->package_volume) }}">
        <input type="hidden" name="comparison_price_per_m3" id="comparison_price_per_m3" value="{{ old('comparison_price_per_m3', $steel->comparison_price_per_m3) }}">
        <input type="hidden" name="package_price" id="package_price" value="{{ old('package_price', $steel->package_price) }}">
        <input type="hidden" name="dimension_length" id="dimension_length" value="{{ old('dimension_length', $steel->dimension_length) }}">
        <input type="hidden" name="dimension_width" id="dimension_width" value="{{ old('dimension_width', $steel->dimension_width) }}">
        <input type="hidden" name="dimension_height" id="dimension_height" value="{{ old('dimension_height', $steel->dimension_height) }}">
        <input type="hidden" name="dimension_thickness" id="dimension_thickness" value="{{ old('dimension_thickness', $steel->dimension_thickness) }}">
            ...
            <div>
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="type" id="type" value="{{ old('type', $steel->type) }}" class="autocomplete-input" data-field="type" autocomplete="off" placeholder="Pilih atau ketik jenis besi...">
                ...
                <div class="row">
                    <label>Merek</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="brand" id="brand" value="{{ old('brand', $steel->brand) }}" class="autocomplete-input" data-field="brand" autocomplete="off" placeholder="Pilih atau ketik merek...">
                ...
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="quality" id="quality" value="{{ old('quality', $steel->quality) }}" class="autocomplete-input" data-field="quality" autocomplete="off" placeholder="Contoh: A, B, Premium...">
                ...
                <div class="row">
                    <label>Istilah</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="term" id="term" value="{{ old('term', $steel->term) }}" class="autocomplete-input" data-field="term" autocomplete="off" placeholder="Contoh: WF, H-Beam, Hollow...">
                        ...
                        <select name="package_unit" id="package_unit" style="width: 100%; height: 100%;">
                            ...
                            @foreach($units as $unit)
                                <option value="{{ $unit->code }}"
                                    data-name="{{ $unit->name }}"
                                    {{ old('package_unit', $steel->package_unit) == $unit->code ? 'selected' : '' }}>
                                    {{ $unit->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div style="flex: 1;">
                        <div class="dimensi-wrapper" style="display: flex; align-items: flex-end; gap: 8px; flex-wrap: wrap;">
                            <div class="dimensi-item" style="display: flex; flex-direction: column; flex: 1; min-width: 110px; position: relative;">
                                ...
                                <div class="dimensi-input-with-unit">
                                    <input type="text" id="dimension_length_input" value="{{ old('dimension_length', $steel->dimension_length) }}" class="autocomplete-input" data-field="dimension_length" inputmode="decimal" placeholder="0" autocomplete="off">
                            ...
                            <div class="dimensi-item" style="display: flex; flex-direction: column; flex: 1; min-width: 110px; position: relative;">
                                ...
                                <div class="dimensi-input-with-unit">
                                    <input type="text" id="dimension_width_input" value="{{ old('dimension_width', $steel->dimension_width) }}" class="autocomplete-input" data-field="dimension_width" inputmode="decimal" placeholder="0" autocomplete="off">
                            ...
                            <div class="dimensi-item" style="display: flex; flex-direction: column; flex: 1; min-width: 110px; position: relative;">
                                ...
                                <div class="dimensi-input-with-unit">
                                    <input type="text" id="dimension_height_input" value="{{ old('dimension_height', $steel->dimension_height) }}" class="autocomplete-input" data-field="dimension_height" inputmode="decimal" placeholder="0" autocomplete="off">
                            ...
                            <div class="dimensi-item" style="display: flex; flex-direction: column; flex: 1; min-width: 110px; position: relative;">
                                ...
                                <div class="dimensi-input-with-unit">
                                    <input type="text" id="dimension_thickness_input" value="{{ old('dimension_thickness', $steel->dimension_thickness) }}" class="autocomplete-input" data-field="dimension_thickness" inputmode="decimal" placeholder="0" autocomplete="off">
                        ...
                        <div class="mini-input-wrapper" style="display: flex; flex-direction: column; margin-top: 10px;">
                            ...
                            <div style="position: relative;">
                                <input type="text" id="volume_display" readonly value="{{ \App\Helpers\NumberHelper::formatPlain((float) old('package_volume', $steel->package_volume)) }}" style="text-align: right; padding-right: 38px; width: 100%; background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); font-weight: 600; color: #15803d; border: 1.5px solid #86efac;">
                ...
                <div class="row">
                    <label>Toko</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="store" id="store" value="{{ old('store', $steel->store) }}" class="autocomplete-input" data-field="store" autocomplete="off" placeholder="Pilih atau ketik nama toko...">
                ...
                <div class="row">
                    <label>Alamat</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="address" id="address" value="{{ old('address', $steel->address) }}" class="autocomplete-input" data-field="address" autocomplete="off" placeholder="Alamat toko...">
                    ...
                    <div style="flex: 1; display: flex; gap: 15px; align-items: stretch;">
                        <div style="flex: 1; display: flex; flex-direction: column; position: relative;">
                            <div style="flex: 1; display: flex; align-items: center; position: relative;">
                                ...
                                <input type="text" id="package_price_display" value="{{ old('package_price', $steel->package_price) }}" class="autocomplete-input" data-field="package_price" inputmode="numeric" placeholder="0" autocomplete="off" style="width: 100%; height: 100%; padding: 10px 70px 10px 38px; font-size: 14px;">
                                <span id="price_unit_display_inline" class="price-suffix" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); font-size: 13px; color: #94a3b8; pointer-events: none;">/ {{ old('package_unit', $steel->packageUnit?->name ?? $steel->package_unit) ?: '-' }}</span>
                            </div>
                        ...
                        <div style="display: flex; flex-direction: column; flex: 1; min-width: 0;">
                            ...
                            <div style="display: flex; align-items: center; position: relative;">
                                <div style="flex: 1; display: flex; align-items: center; position: relative;">
                                    <span class="price-prefix" style="position: absolute; left: 10px; font-size: 14px; font-weight: 600; color: #64748b; pointer-events: none; z-index: 1;">Rp</span>
                                    <input type="text" id="comparison_price_display" value="{{ old('comparison_price_per_m3', $steel->comparison_price_per_m3) }}" class="autocomplete-input" data-field="comparison_price_per_m3" inputmode="numeric" placeholder="0" autocomplete="off" style="width: 100%; height: 38px; padding: 10px 50px 10px 38px; font-size: 14px;">
                ...
                <div>
                    <div class="image-preview-box" id="photoPreviewArea"
                        ...
                        @if($steel->photo_url)
                            ...
                            <img id="photoPreview" src="{{ $steel->photo_url }}" alt="Preview" style="display: block; max-width: 100%; max-height: 100%; width: auto; height: auto; object-fit: contain;">
                        @else
                    ...
                    <div class="image-actions" style="margin-top: 5px; display: flex; justify-content: center; font-weight: bold; font-size: 14px; padding: 0 10px; gap: 10px;">
                        ...
                        <span class="text-delete" id="deletePhotoBtn" style="color: #d9534f; cursor: pointer; display: {{ $steel->photo_url ? 'inline' : 'none' }};"><i class="bi bi-trash"></i> Hapus</span>
                    </div>
                </div>

@php
    ...
    $packageUnitStaticOptions = $packageUnitOptions
        ...
        ->unique('value')
        ->values();
    $packageUnitStaticOptionsJson = json_encode($packageUnitStaticOptions, JSON_UNESCAPED_UNICODE);
...
@elseif($material['type'] == 'cat')
    ...
    <td>
        <input
            ...
            data-inline-static-options="{{ $packageUnitStaticOptionsJson }}"
...
@elseif($material['type'] == 'steel')
    <td class="material-inline-row-no steel-sticky-col col-no" style="text-align:center;">+</td>
    <td class="steel-sticky-col col-type"><input autocomplete="off" class="material-inline-input" name="type" data-inline-field="type" form="{{ $inlineFormId }}"></td>
    <td class="steel-sticky-col col-brand steel-sticky-edge"><input autocomplete="off" class="material-inline-input" name="brand" data-inline-field="brand" form="{{ $inlineFormId }}"></td>
    <td><input autocomplete="off" class="material-inline-input" name="quality" data-inline-field="quality" form="{{ $inlineFormId }}"></td>
    <td><input autocomplete="off" class="material-inline-input" name="term" data-inline-field="term" form="{{ $inlineFormId }}"></td>
    <td>
        <input
            autocomplete="off"
            class="material-inline-input"
    ...
    <td class="dim-cell border-right-none"><input autocomplete="off" class="material-inline-input" name="dimension_length" data-inline-field="dimension_length" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 30px; min-width: 30px;">M</td>
    <td class="dim-cell border-right-none"><input autocomplete="off" class="material-inline-input" name="dimension_width" data-inline-field="dimension_width" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 32px; min-width: 32px;">mm</td>
    <td class="dim-cell border-right-none"><input autocomplete="off" class="material-inline-input" name="dimension_height" data-inline-field="dimension_height" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 32px; min-width: 32px;">mm</td>
    <td class="dim-cell border-right-none"><input autocomplete="off" class="material-inline-input" name="dimension_thickness" data-inline-field="dimension_thickness" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 32px; min-width: 32px;">mm</td>
    <td><input autocomplete="off" class="material-inline-input" name="package_volume" data-inline-field="package_volume" form="{{ $inlineFormId }}"></td>
    <td style="text-align:left;">M3</td>
    @if($showStoreInfo)
...
@elseif($material['type'] == 'kasa_gypsum')
    ...
    <td class="dim-cell border-right-none"><input autocomplete="off" class="material-inline-input" name="dimension_width" data-inline-field="dimension_width" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 30px; min-width: 30px;">cm</td>
    <td class="dim-cell border-right-none"><input autocomplete="off" class="material-inline-input" name="dimension_length" data-inline-field="dimension_length" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 24px; min-width: 24px;">M</td>
    @if($showStoreInfo)
        <td><input autocomplete="off" class="material-inline-input" name="store" data-inline-field="store" form="{{ $inlineFormId }}"></td>
        <td><input autocomplete="off" class="material-inline-input" name="address" data-inline-field="address" form="{{ $inlineFormId }}"></td>
    @endif
    ...
    <td style="text-align:left;">/ Unit</td>
    <td style="text-align:right;">Rp</td>
    <td><input autocomplete="off" class="material-inline-input" name="comparison_price_per_m" data-inline-field="comparison_price_per_m" form="{{ $inlineFormId }}"></td>
    <td style="text-align:left;">/ M</td>

@elseif($material['type'] == 'paku_tembak')
    <td class="material-inline-row-no paku-tembak-sticky-col col-no" style="text-align:center;">+</td>
    <td class="paku-tembak-sticky-col col-type"><input autocomplete="off" class="material-inline-input" name="type" data-inline-field="type" form="{{ $inlineFormId }}"></td>
    <td class="paku-tembak-sticky-col col-brand paku-tembak-sticky-edge"><input autocomplete="off" class="material-inline-input" name="brand" data-inline-field="brand" form="{{ $inlineFormId }}"></td>
    <td>
        <input
            autocomplete="off"
            class="material-inline-input"
    ...
    <td class="border-right-none"><input autocomplete="off" class="material-inline-input" name="mesiu_code" data-inline-field="mesiu_code" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none border-right-none"><input autocomplete="off" class="material-inline-input" name="mesiu_size" data-inline-field="mesiu_size" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none border-right-none" style="text-align:left; width: 30px; min-width: 30px;">cm</td>
    <td class="border-left-none border-right-none"><input autocomplete="off" class="material-inline-input" name="mesiu_content" data-inline-field="mesiu_content" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 36px; min-width: 36px;">Pcs</td>
    <td class="border-right-none"><input autocomplete="off" class="material-inline-input" name="paku_code" data-inline-field="paku_code" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none border-right-none"><input autocomplete="off" class="material-inline-input" name="paku_size" data-inline-field="paku_size" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none border-right-none" style="text-align:left; width: 30px; min-width: 30px;">cm</td>
    <td class="border-left-none border-right-none"><input autocomplete="off" class="material-inline-input" name="paku_content" data-inline-field="paku_content" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 36px; min-width: 36px;">Pcs</td>
    @if($showStoreInfo)
        <td><input autocomplete="off" class="material-inline-input" name="store" data-inline-field="store" form="{{ $inlineFormId }}"></td>
        <td><input autocomplete="off" class="material-inline-input" name="address" data-inline-field="address" form="{{ $inlineFormId }}"></td>
    ...
    <td style="text-align:left;">/ Unit</td>
    <td style="text-align:right;">Rp</td>
    <td><input autocomplete="off" class="material-inline-input" name="comparison_price" data-inline-field="comparison_price" form="{{ $inlineFormId }}"></td>
    <td style="text-align:left;">/ isi</td>

@elseif($material['type'] == 'paku')
    <td class="material-inline-row-no paku-sticky-col col-no" style="text-align:center;">+</td>
    <td class="paku-sticky-col col-type"><input autocomplete="off" class="material-inline-input" name="type" data-inline-field="type" form="{{ $inlineFormId }}"></td>
    <td class="paku-sticky-col col-brand"><input autocomplete="off" class="material-inline-input" name="brand" data-inline-field="brand" form="{{ $inlineFormId }}"></td>
    <td class="dim-cell paku-sticky-col"><input autocomplete="off" class="material-inline-input" name="dimension_length" data-inline-field="dimension_length" form="{{ $inlineFormId }}"></td>
    <td class="paku-sticky-col" style="text-align:center; width: 24px; min-width: 24px;">"</td>
    <td class="dim-cell paku-sticky-col"><input autocomplete="off" class="material-inline-input" name="dimension_length_mm" data-inline-field="dimension_length_mm" form="{{ $inlineFormId }}"></td>
    <td class="paku-sticky-col" style="text-align:center; width: 30px; min-width: 30px;">mm</td>
    <td class="dim-cell paku-sticky-col"><input autocomplete="off" class="material-inline-input" name="dimension_body_diameter" data-inline-field="dimension_body_diameter" form="{{ $inlineFormId }}"></td>
    <td class="paku-sticky-col" style="text-align:center; width: 30px; min-width: 30px;">cm</td>
    <td class="dim-cell paku-sticky-col"><input autocomplete="off" class="material-inline-input" name="dimension_head_diameter" data-inline-field="dimension_head_diameter" form="{{ $inlineFormId }}"></td>
    <td class="paku-sticky-col paku-sticky-edge" style="text-align:center; width: 30px; min-width: 30px;">mm</td>
    <td><input autocomplete="off" class="material-inline-input" name="color" data-inline-field="color" form="{{ $inlineFormId }}"></td>
    <td>
        <input
            autocomplete="off"
    ...
    <td class="border-right-none"><input autocomplete="off" class="material-inline-input" name="package_weight" data-inline-field="package_weight" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 30px; min-width: 30px;">kg</td>
    <td class="border-right-none"><input autocomplete="off" class="material-inline-input" name="package_content" data-inline-field="package_content" form="{{ $inlineFormId }}"></td>
    <td class="border-left-none" style="text-align:left; width: 36px; min-width: 36px;">Pcs</td>
    @if($showStoreInfo)
        <td><input autocomplete="off" class="material-inline-input" name="store" data-inline-field="store" form="{{ $inlineFormId }}"></td>
        <td><input autocomplete="off" class="material-inline-input" name="address" data-inline-field="address" form="{{ $inlineFormId }}"></td>
    ...
    <td class="text-center action-cell">
        <div class="btn-group-compact">
            ...
            <input type="file"
                ...
                form="{{ $inlineFormId }}"
                style="display:none;">
            <button type="submit" form="{{ $inlineFormId }}" class="btn btn-action btn btn-primary" title="Simpan">

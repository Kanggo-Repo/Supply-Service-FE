...
(function() {
    function updateCeramicScrollIndicators() {
        const cells = document.querySelectorAll('#section-ceramic .ceramic-scroll-td, #section-cement .cement-scroll-td, #section-sand .sand-scroll-td, #section-steel .sand-scroll-td, #section-kasa_gypsum .sand-scroll-td, #section-paku_tembak .sand-scroll-td, #section-paku .sand-scroll-td, #section-cat .cat-scroll-td, #section-brick .brick-scroll-td');
        cells.forEach(td => {
...
.kanggo-img-link.material-letter-blink .kanggo-img {
  ...
  .material-inline-editor-row[data-inline-mode="create"] .steel-sticky-col,
  .material-inline-editor-row[data-inline-mode="create"] .paku-tembak-sticky-col,
  .material-inline-editor-row[data-inline-mode="create"] .paku-sticky-col,
  ...
  .material-inline-editor-row[data-inline-mode="edit"] .steel-sticky-col,
  .material-inline-editor-row[data-inline-mode="edit"] .paku-tembak-sticky-col,
  .material-inline-editor-row[data-inline-mode="edit"] .paku-sticky-col,
  ...
  .material-inline-editor-row .steel-sticky-col .material-inline-input,
  .material-inline-editor-row .paku-tembak-sticky-col .material-inline-input,
  .material-inline-editor-row .paku-sticky-col .material-inline-input,
  ...
  #section-steel .table-container thead,
  #section-kasa_gypsum .table-container thead,
  #section-paku_tembak .table-container thead,
  ...
  #section-steel .table-container thead.has-dim-sub tr.dim-group-row th,
  #section-kasa_gypsum .table-container thead.has-dim-sub tr.dim-group-row th,
  ...
  #section-steel .table-container thead.has-dim-sub tr.dim-sub-row th,
  #section-kasa_gypsum .table-container thead.has-dim-sub tr.dim-sub-row th,
  ...
  #section-steel .table-container thead th,
  #section-kasa_gypsum .table-container thead th,
  #section-paku_tembak .table-container thead th,
  ...
  #section-steel .table-container tbody td,
  #section-kasa_gypsum .table-container tbody td,
  #section-paku_tembak .table-container tbody td,
  #section-paku .table-container tbody td {
  ...
  #section-steel .table-container tbody td.dim-cell,
  #section-kasa_gypsum .table-container tbody td.dim-cell {
      text-align: center !important;
      font-size: 12px !important;
      width: 40px !important;
  ...
  #section-steel .sand-scroll-td,
  #section-kasa_gypsum .sand-scroll-td,
  #section-paku_tembak .sand-scroll-td,
  #section-paku .sand-scroll-td,
  ...
  #section-steel .sand-scroll-td.is-scrollable::after,
  #section-kasa_gypsum .sand-scroll-td.is-scrollable::after,
  #section-paku_tembak .sand-scroll-td.is-scrollable::after,
  #section-paku .sand-scroll-td.is-scrollable::after,
  ...
  #section-steel .sand-scroll-td.is-scrolled-end::after,
  #section-kasa_gypsum .sand-scroll-td.is-scrolled-end::after,
  #section-paku_tembak .sand-scroll-td.is-scrolled-end::after,
  #section-paku .sand-scroll-td.is-scrolled-end::after,
  ...
  #section-steel .sand-scroll-cell,
  #section-kasa_gypsum .sand-scroll-cell,
  #section-paku_tembak .sand-scroll-cell,
  #section-paku .sand-scroll-cell,
  ...
  #section-steel .sand-scroll-cell::-webkit-scrollbar,
  #section-kasa_gypsum .sand-scroll-cell::-webkit-scrollbar,
  #section-paku_tembak .sand-scroll-cell::-webkit-scrollbar,
  #section-paku .sand-scroll-cell::-webkit-scrollbar,
  ...
  #section-steel .table-container tbody td.volume-cell,
  #section-kasa_gypsum .table-container tbody td.volume-cell {
      text-align: right !important;
      font-size: 12px !important;
...
/* --- STEEL STICKY --- */
#section-steel .steel-sticky-col {
    position: sticky;
    background: #ffffff;
    z-index: 3;
}
#section-steel thead .steel-sticky-col {
    z-index: 30;
}
#section-steel .steel-sticky-edge {
    box-shadow: 2px 0 0 rgba(148, 163, 184, 0.2);
}

/* --- PAKU TEMBAK STICKY --- */
#section-paku_tembak .paku-tembak-sticky-col {
    position: sticky;
    background: #ffffff;
    z-index: 3;
}
#section-paku_tembak thead .paku-tembak-sticky-col {
    z-index: 30;
}
#section-paku_tembak .paku-tembak-sticky-edge {
    box-shadow: 2px 0 0 rgba(148, 163, 184, 0.2);
}

/* --- PAKU STICKY --- */
#section-paku .paku-sticky-col {
    position: sticky;
    background: #ffffff;
    z-index: 3;
}
#section-paku thead .paku-sticky-col {
    z-index: 30;
}
#section-paku .paku-sticky-edge {
    box-shadow: 2px 0 0 rgba(148, 163, 184, 0.2);
}
                ...
                @foreach($materials as $material)
                    <div class="material-tab-action {{ $material['type'] === $activeTab ? 'active' : '' }}" data-tab="{{ $material['type'] }}">
                        <form action="{{ route('materials.index') }}" method="GET" class="material-search-form manual-search" data-search-manual="true">
                            ...
                            @if(request('search'))
                                <a href="{{ route('materials.index', ['tab' => $material['type']]) }}" class="btn btn-secondary material-search-reset-btn">
    ...
    <div class="floating-modal-content" style="width: 600px;">
        ...
        <div class="floating-modal-body">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px;">
                ...
                <a href="{{ route('steels.create') }}" class="material-choice-card open-modal">
                    <div class="material-choice-icon">ðŸ”©</div>
                    <div class="material-choice-label">Besi</div>
                    <div class="material-choice-desc">Tambah data besi</div>
                </a>
                <a href="{{ route('kasa_gypsums.create') }}" class="material-choice-card open-modal">
                    <div class="material-choice-icon">🧵</div>
                    <div class="material-choice-label">Kasa Gypsum</div>
                    <div class="material-choice-desc">Tambah data kasa gypsum</div>
                </a>
                <a href="{{ route('paku_tembaks.create') }}" class="material-choice-card open-modal">
                    <div class="material-choice-icon">🔩</div>
                    <div class="material-choice-label">Paku Tembak</div>
                    <div class="material-choice-desc">Tambah data paku tembak</div>
                </a>
                <a href="{{ route('pakus.create') }}" class="material-choice-card open-modal">
                    <div class="material-choice-icon">📌</div>
                    <div class="material-choice-label">Paku</div>
                    <div class="material-choice-desc">Tambah data paku</div>
                </a>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function submitHistoryRestoreViaAjax(form) {
        if (form.__historyRestoreSubmitting) return;
        form.__historyRestoreSubmitting = true;
        showLoadingState(form);
        ...
        try {
            ...
            if (!response.ok || payload?.success === false) {
                throw new Error(payload?.message || 'Gagal memulihkan riwayat material.');
            }

            if (payload?.changed === false || !payload?.updated_material) {
                if (typeof window.showConfirm === 'function') {
                    await window.showConfirm({
                        title: 'Tidak Ada Perubahan',
                        message: payload?.message || 'Nilai material sudah sama dengan riwayat yang dipilih.',
                        confirmText: 'Tutup',
                        type: 'info',
                        hideCancel: true,
                    });
                } else if (typeof window.showToast === 'function') {
                    window.showToast(payload?.message || 'Nilai material sudah sama dengan riwayat yang dipilih.', 'info');
                }
                return;
            }

            try {
                sessionStorage.setItem('pendingMaterialFocus', JSON.stringify(payload.updated_material));
                sessionStorage.setItem('pendingToast', JSON.stringify({
                    type: 'success',
                    message: payload?.message || 'Riwayat material berhasil dipulihkan.',
                }));
            } catch (e) {
                // Ignore storage errors
            }

            let redirectUrl = payload?.redirect_url || window.location.href;
            try {
                const focusUrl = new URL(redirectUrl, window.location.origin);
                focusUrl.searchParams.set('tab', String(payload.updated_material.type));
                focusUrl.searchParams.set('_focus_type', String(payload.updated_material.type));
                focusUrl.searchParams.set('_focus_id', String(payload.updated_material.id));
            ...
            console.error('[Modal] History restore error:', error);
            if (typeof window.showToast === 'function') {
                window.showToast(error.message || 'Gagal memulihkan riwayat material.', 'error');
            }
        } finally {
            form.__historyRestoreSubmitting = false;
    ...
    function getMaterialInfo(url) {
        ...
        } else if (url.includes('/steels/')) {
            materialType = 'steel';
            materialLabel = 'Besi';
        } else if (url.includes('/kasa_gypsums/')) {
            materialType = 'kasa_gypsum';
            materialLabel = 'Kasa Gypsum';
        } else if (url.includes('/paku_tembaks/')) {
            materialType = 'paku_tembak';
            materialLabel = 'Paku Tembak';
        } else if (url.includes('/pakus/')) {
            materialType = 'paku';
            materialLabel = 'Paku';
        }
    ...
    function loadMaterialFormScript(materialType, modalBodyEl, options = {}) {
        ...
        const pascalType = scriptType
            .split(/[-_]+/)
            .filter(Boolean)
            .map((part) => part.charAt(0).toUpperCase() + part.slice(1))
            .join('');
        const scriptProperty = `${scriptType}FormScriptLoaded`;
        const initFunctionName = `init${pascalType}Form`;
        console.log('[Modal] Loading script for:', materialType, 'Init function:', initFunctionName);

        if (!window[scriptProperty]) {
            console.log('[Modal] Script not loaded yet, loading:', `/js/${scriptType}-form.js`);
            const script = document.createElement('script');
            script.src = `/js/${scriptType}-form.js?v=${Date.now()}`;
            script.onload = () => {
    ...
    function isInlinePackageUnitField(fieldName) {
        return String(fieldName || '').trim().toLowerCase() === 'package_unit';
    }

    function setInlinePackageUnitSelection(input, option) {
        if (!input) return;
        if (!option || !option.value) {
            delete input.dataset.inlineSelectedCode;
            delete input.dataset.inlineSelectedLabel;
            return;
        }
        input.dataset.inlineSelectedCode = option.value;
        input.dataset.inlineSelectedLabel = option.label || option.value;
    }

    function getInlineStaticAutocompleteOptions(input, fieldName) {
        if (!input) return [];
        const normalizedFieldName = String(fieldName || input.getAttribute('data-inline-field') || '').trim();
        const rawOptions = input.getAttribute('data-inline-static-options') || '';
        if (rawOptions) {
            if (input.__inlineStaticOptionsCacheRaw === rawOptions && Array.isArray(input.__inlineStaticOptionsCache)) {
                return input.__inlineStaticOptionsCache;
            }
            try {
                const parsedOptions = JSON.parse(rawOptions);
                const normalizedOptions = (Array.isArray(parsedOptions) ? parsedOptions : [])
                    .map((option) => normalizeInlineAutocompleteOption(normalizedFieldName, option))
                    .filter(Boolean);
                input.__inlineStaticOptionsCacheRaw = rawOptions;
                input.__inlineStaticOptionsCache = normalizedOptions;
                return normalizedOptions;
            } catch (error) {
                console.error('Inline static options parse error:', error);
            }
        }

        const rawValues = input.getAttribute('data-inline-static-values') || '';
        if (!rawValues) return [];
        return rawValues
            .split('|')
            .map(value => normalizeInlineAutocompleteOption(normalizedFieldName, value))
            .filter(Boolean);
    }

    function findInlineStaticOptionByText(input, fieldName, rawValue) {
        const value = (rawValue ?? '').toString().trim();
        if (!value) return null;
        const normalizedValue = value.toLowerCase();
        const options = getInlineStaticAutocompleteOptions(input, fieldName);
    ...
    function getInlinePackageUnitSubmissionValue(input) {
        if (!input) return '';
        const fieldName = input.getAttribute('data-inline-field') || '';
        if (!isInlinePackageUnitField(fieldName)) {
            return (input.value ?? '').toString();
        }

        const typedValue = (input.value ?? '').toString().trim();
        if (!typedValue) return '';

        const matchedOption = findInlineStaticOptionByText(input, fieldName, typedValue);
        if (matchedOption?.value) {
            setInlinePackageUnitSelection(input, matchedOption);
            return matchedOption.value;
        }

        const selectedCode = (input.dataset.inlineSelectedCode || '').trim();
        const selectedLabel = (input.dataset.inlineSelectedLabel || '').trim();
        const normalizedTyped = typedValue.toLowerCase();
        if (selectedCode && (
            normalizedTyped === selectedCode.toLowerCase() ||
            (selectedLabel && normalizedTyped === selectedLabel.toLowerCase())
        )) {
            return selectedCode;
        }
    ...
    function populateInlineRowFromSource(row, sourceRow) {
        ...
        row.querySelectorAll('[data-inline-field]').forEach(field => {
            ...
            const normalizedValue = normalizeInlineInputValue(fieldName, sourceValue);
            if (isInlinePackageUnitField(fieldName)) {
                const matchedOption = findInlineStaticOptionByText(field, fieldName, normalizedValue);
                if (matchedOption) {
                    setInlinePackageUnitSelection(field, matchedOption);
                    field.value = matchedOption.label || matchedOption.value;
                } else {
                    setInlinePackageUnitSelection(field, null);
    ...
    function syncInlinePhotoButtonState(row) {
        ...
        const existingPhotoPath = (row.dataset.inlineExistingPhotoPath || '').trim();
        const hasExistingPhoto = existingPhotoPath !== '';
        const hasPhoto = hasFile || hasExistingPhoto;

        trigger.classList.toggle('has-file', hasPhoto);
        trigger.classList.toggle('is-empty', !hasPhoto);
        if (hasFile) {
        ...
        if (hasExistingPhoto) {
            const fileName = existingPhotoPath.split('/').pop() || 'foto tersedia';
            trigger.setAttribute('title', `Foto tersimpan: ${fileName}`);
            return;
        }
    ...
    function appendAssociatedControlToInlinePayload(formData, control) {
        ...
        if (control instanceof HTMLInputElement) {
            ...
            const fieldName = control.getAttribute('data-inline-field') || name;
            const valueToSubmit = isInlinePackageUnitField(fieldName)
                ? getInlinePackageUnitSubmissionValue(control)
                : (control.value ?? '');
            formData.append(name, valueToSubmit);
            return;
        }
    ...
    const INLINE_AUTOCOMPLETE_CASCADE_ORDER = Object.freeze({
        bricks: [
            'type',
            'brand',
            'form',
    ...
    function applyInlineAutocompleteSelection(input, list, option) {
        ...
        const isPackageUnit = isInlinePackageUnitField(fieldName);
        const displayValue = isPackageUnit
            ? (normalizedOption.label || normalizedOption.value)
            : normalizedOption.value;
        const normalizedSelected = (displayValue ?? '').toString().trim().toLowerCase();
        if (!normalizedSelected) return;

        if (isPackageUnit) {
            setInlinePackageUnitSelection(input, normalizedOption);
        }
    ...
    function selectInlineAutocompleteActive(input, list) {
        ...
        const option = {
            value: pickedItem.dataset.value || pickedItem.textContent || '',
            label: pickedItem.dataset.label || pickedItem.dataset.value || pickedItem.textContent || '',
        };
        applyInlineAutocompleteSelection(input, list, option);
        return true;
    }

    function normalizeInlineAutocompleteOption(fieldName, option) {
        if (option === null || option === undefined) return null;

        const rawValue = typeof option === 'object' ? (option.value ?? option.code ?? '') : option;
        const normalizedValue = normalizeInlineAutocompleteValue(fieldName, String(rawValue ?? '').trim());
        if (!normalizedValue) return null;

        const rawLabel = typeof option === 'object'
            ? (option.label ?? option.name ?? option.display ?? normalizedValue)
            : normalizedValue;
        const normalizedLabel = String(rawLabel ?? '').trim() || normalizedValue;
    ...
    function fillInlineAutocompleteList(list, input, items) {
        ...
        list.dataset.activeIndex = '-1';
        const fieldName = input.getAttribute('data-inline-field') || '';
        const currentValue = (isInlinePackageUnitField(fieldName)
            ? getInlinePackageUnitSubmissionValue(input)
            : normalizeInlineAutocompleteValue(fieldName, input.value))
            .toString()
            .trim()
            .toLowerCase();
        ...
        (Array.isArray(items) ? items : []).forEach((item) => {
            const normalizedOption = normalizeInlineAutocompleteOption(fieldName, item);
            if (!normalizedOption) return;
            const normalizedKey = normalizedOption.value.toLowerCase();
            if (normalizedKey === currentValue || seenValues.has(normalizedKey)) return;
    ...
    function buildInlineAutocompleteUrl(resource, field, term, row) {
        ...
        function normalizeInlineCascadeFilterValue(fieldName, rawValue) {
            const value = (rawValue ?? '').toString().trim();
            if (!value) return '';

            if (INLINE_INTEGER_PRICE_FIELDS.has(fieldName)) {
                const parsedPrice = parseInlinePriceInteger(value);
                return Number.isFinite(parsedPrice) ? formatInlineNumeric(parsedPrice, 0) : '';
            }

            const compact = value.replace(/\s+/g, '');
            if (/^-?\d+(?:[.,]\d+)?$/.test(compact)) {
                const parsedNumeric = parseInlineNumeric(value);
                if (Number.isFinite(parsedNumeric)) {
                    return formatInlineNumeric(parsedNumeric, 6);
                }
            }
        ...
        function appendInlineCascadeParams(baseUrl) {
            const order = INLINE_AUTOCOMPLETE_CASCADE_ORDER[resource] || [];
            const currentIndex = order.indexOf(field);
            if (currentIndex <= 0 || !row) {
                return baseUrl;
            }

            let nextUrl = baseUrl;
            for (let i = 0; i < currentIndex; i++) {
                const parentField = order[i];
                if (parentField === field || parentField === 'store' || parentField === 'address') {
                    continue;
                }

                const parentInput = row.querySelector(`[data-inline-field="${parentField}"]`);
                if (!parentInput) {
                    continue;
                }

                const parentRawValue = isInlinePackageUnitField(parentField)
                    ? getInlinePackageUnitSubmissionValue(parentInput)
                    : parentInput.value;
                const parentValue = normalizeInlineCascadeFilterValue(parentField, parentRawValue);
                if (!parentValue) {
                    continue;
                }

                nextUrl += `&${encodeURIComponent(parentField)}=${encodeURIComponent(parentValue)}`;
            }
        ...
        const baseUrl = `/api/${resource}/field-values/${field}?search=${encodedTerm}&limit=${limit}${kindsParam}`;
        return appendInlineCascadeParams(baseUrl);
    }
    ...
    function getInlineStaticSuggestions(input, term) {
        ...
        return options.filter((option) => {
            ...
            return valueText.includes(normalizedTerm) || labelText.includes(normalizedTerm);
        });
    }

    async function fetchInlineAutocompleteSuggestions(input, row, options = {}) {
        ...
        const useInputTerm = options.useInputTerm === true;
        const term = useInputTerm ? (input.value || '').trim() : '';
        ...
        if (input.hasAttribute('data-inline-static-values') || input.hasAttribute('data-inline-static-options')) {
    ...
    function bindInlineComputedFields(row) {
        ...
        const comparisonFields = new Set(['comparison_price_per_m3', 'comparison_price_per_kg', 'comparison_price_per_m2', 'comparison_price_per_m', 'comparison_price']);
    ...
    function recalculateInlineComputedFields(row) {
            ...
            if (Number.isFinite(volume) && volume > 0) {
                if (isKubik) {
                    if (lastEditedPrice === 'comparison' && Number.isFinite(comparison)) {
                        setInlineFieldNumeric(row, 'price_per_piece', comparison, 0);
                    } else if (Number.isFinite(price)) {
                        setInlineFieldNumeric(row, 'comparison_price_per_m3', price, 0);
                    }
                } else {
                    if (lastEditedPrice === 'comparison' && Number.isFinite(comparison)) {
        ...
        if (resource === 'steels') {
            ...
            const w = getInlineFieldNumeric(row, 'dimension_width');
            const h = getInlineFieldNumeric(row, 'dimension_height');
            const t = getInlineFieldNumeric(row, 'dimension_thickness');
            if (Number.isFinite(l) && Number.isFinite(w) && Number.isFinite(h) && Number.isFinite(t) && l > 0 && w > 0 && h > 0 && t > 0) {
                const volumeM3 = 2 * ((w + h) / 100) * l * (t / 1000);
                setInlineFieldNumeric(row, 'package_volume', volumeM3, 6);
            }
            const volume = getInlineFieldNumeric(row, 'package_volume');
            const price = getInlineFieldNumeric(row, 'package_price');
        ...
        if (resource === 'kasa_gypsums') {
            const length = getInlineFieldNumeric(row, 'dimension_length');
            const price = getInlineFieldNumeric(row, 'package_price');
            const comparison = getInlineFieldNumeric(row, 'comparison_price_per_m');
            const baseLength = Number.isFinite(length) && length > 0 ? length : NaN;
            if (Number.isFinite(baseLength) && baseLength > 0) {
                if (lastEditedPrice === 'comparison' && Number.isFinite(comparison)) {
                    setInlineFieldNumeric(row, 'package_price', comparison * baseLength, 0);
                } else if (Number.isFinite(price)) {
                    setInlineFieldNumeric(row, 'comparison_price_per_m', price / baseLength, 0);
                }
            }
            return;
        }

        if (resource === 'paku_tembaks') {
            const mesiuContent = getInlineFieldNumeric(row, 'mesiu_content');
            const pakuContent = getInlineFieldNumeric(row, 'paku_content');
            const price = getInlineFieldNumeric(row, 'package_price');
            const comparison = getInlineFieldNumeric(row, 'comparison_price');
            const totalContent = (Number.isFinite(mesiuContent) ? mesiuContent : 0) + (Number.isFinite(pakuContent) ? pakuContent : 0);
            if (Number.isFinite(totalContent) && totalContent > 0) {
                if (lastEditedPrice === 'comparison' && Number.isFinite(comparison)) {
                    setInlineFieldNumeric(row, 'package_price', comparison * totalContent, 0);
                } else if (Number.isFinite(price)) {
                    setInlineFieldNumeric(row, 'comparison_price', price / totalContent, 0);
                }
            }
            return;
        }
        ...
        if (resource === 'pakus') {
            const content = getInlineFieldNumeric(row, 'package_content');
            const price = getInlineFieldNumeric(row, 'package_price');
            const comparison = getInlineFieldNumeric(row, 'comparison_price');
            if (Number.isFinite(content) && content > 0) {
                if (lastEditedPrice === 'comparison' && Number.isFinite(comparison)) {
                    setInlineFieldNumeric(row, 'package_price', comparison * content, 0);
                } else if (Number.isFinite(price)) {
                    setInlineFieldNumeric(row, 'comparison_price', price / content, 0);
                }
            }
            return;
        }
        ...
        row.querySelectorAll('.material-inline-input[data-inline-field]').forEach(input => {
            ...
            const schedule = () => {
                ...
                const timer = window.setTimeout(() => {
                    fetchInlineAutocompleteSuggestions(input, row, { useInputTerm: true });
                }, 220);
                inlineAutocompleteTimers.set(input, timer);
            };

            const scheduleAllOptions = () => {
                const normalizedCurrent = (input.value || '').toString().trim().toLowerCase();
                if (
                    input.__inlineAutocompleteLockedValue === normalizedCurrent &&
                    Date.now() < (input.__inlineAutocompleteLockedUntil || 0)
                ...
                if (existingTimer) clearTimeout(existingTimer);
                const timer = window.setTimeout(() => {
                    fetchInlineAutocompleteSuggestions(input, row, { useInputTerm: false });
                }, 120);
                inlineAutocompleteTimers.set(input, timer);
            };
            ...
            if (!INLINE_AUTOCOMPLETE_SKIP_FIELDS.has(fieldName)) {
                if (isInlinePackageUnitField(fieldName)) {
                    input.addEventListener('input', () => {
                        setInlinePackageUnitSelection(input, null);
                    });
                }
    ...
    async function openInlineEditor(triggerEl) {
        ...
        if (action === 'edit' && sourceRow) {
            inlineRow.dataset.inlineExistingPhotoPath = sourceRow.getAttribute('data-inline-photo-path') || '';
    ...
    if (modal && modalBody && modalTitle && closeBtn && backdrop) {
        ...
        function initMaterialHistoryNavigators(root = document) {
            root.querySelectorAll('[data-history-stage]').forEach(stage => {
                ...
                const sync = () => {
                    ...
                    navs.forEach(nav => {
                        const pageIndicator = nav.querySelector('[data-history-page-indicator]');
        ...
        function syncMaterialHistoryHeights(root = document) {
            ...
            root.querySelectorAll('[data-material-detail-layout]').forEach(layout => {
                ...
                if (availableHeight > 160) {
                    historyPanel.style.flex = '1 1 auto';
        ...
        document.body.addEventListener('click', function(e) {
            ...
            .then(html => {
                ...
                const content = doc.querySelector('.card') || doc.querySelector('form') || doc.body;
    ...
    function applyAllStickyOffsets() {
        ...
        // Apply to Steel
        applyToSection('section-steel', 'steel-sticky-col');

        // Apply to Paku Tembak
        applyToSection('section-paku_tembak', 'paku-tembak-sticky-col');

<div class="card">
    ...
    <form action="{{ route('pakus.update', $paku->id) }}" method="POST" enctype="multipart/form-data" id="pakuForm">
        @csrf
        @method('PUT')

        <input type="hidden" name="material_name" id="material_name" value="{{ old('material_name', $paku->material_name) }}">
        <input type="hidden" name="comparison_price" id="comparison_price" value="{{ old('comparison_price', $paku->comparison_price) }}">
        <input type="hidden" name="package_price" id="package_price" value="{{ old('package_price', $paku->package_price) }}">
        <input type="hidden" name="package_weight" id="package_weight" value="{{ old('package_weight', $paku->package_weight) }}">
        <input type="hidden" name="package_content" id="package_content" value="{{ old('package_content', $paku->package_content) }}">
        <input type="hidden" name="dimension_length" id="dimension_length" value="{{ old('dimension_length', $paku->dimension_length) }}">
        <input type="hidden" name="dimension_length_mm" id="dimension_length_mm" value="{{ old('dimension_length_mm', $paku->dimension_length_mm) }}">
        <input type="hidden" name="dimension_body_diameter" id="dimension_body_diameter" value="{{ old('dimension_body_diameter', $paku->dimension_body_diameter) }}">
        <input type="hidden" name="dimension_head_diameter" id="dimension_head_diameter" value="{{ old('dimension_head_diameter', $paku->dimension_head_diameter) }}">
            ...
            <div>
                <div class="row">
                    ...
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="type" id="type" value="{{ old('type', $paku->type) }}" class="autocomplete-input" data-field="type" autocomplete="off" placeholder="Pilih atau ketik jenis paku...">
                ...
                <div class="row">
                    <label>Merek</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="brand" id="brand" value="{{ old('brand', $paku->brand) }}" class="autocomplete-input" data-field="brand" autocomplete="off" placeholder="Pilih atau ketik merek...">
                ...
                <div class="row">
                    <label>Warna</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="color" id="color" value="{{ old('color', $paku->color) }}" class="autocomplete-input" data-field="color" autocomplete="off" placeholder="Pilih atau ketik warna...">
                        ...
                        <select name="package_unit" id="package_unit" style="width: 100%; height: 100%;">
                            ...
                            @foreach($units as $unit)
                                <option value="{{ $unit->code }}"
                                    data-name="{{ $unit->name }}"
                                    {{ old('package_unit', $paku->package_unit) == $unit->code ? 'selected' : '' }}>
                                    {{ $unit->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row" style="align-items: flex-start; margin-top: 10px;">
                    ...
                    <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                        <div style="position: relative;">
                            <input type="text" id="package_weight_display" value="{{ old('package_weight', $paku->package_weight) }}" class="autocomplete-input" inputmode="decimal" placeholder="Berat isi" style="padding-right: 42px;">
                        ...
                        <div style="position: relative;">
                            <input type="text" id="package_content_display" value="{{ old('package_content', $paku->package_content) }}" class="autocomplete-input" inputmode="decimal" placeholder="Jumlah isi" style="padding-right: 46px;">
                ...
                <div class="row">
                    <label>Toko</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="store" id="store" value="{{ old('store', $paku->store) }}" class="autocomplete-input" data-field="store" autocomplete="off" placeholder="Pilih atau ketik nama toko...">
                ...
                <div class="row">
                    <label>Alamat</label>
                    <div style="flex: 1; position: relative;">
                        <input type="text" name="address" id="address" value="{{ old('address', $paku->address) }}" class="autocomplete-input" data-field="address" autocomplete="off" placeholder="Alamat toko...">
                    ...
                    <div style="flex: 1; display: flex; gap: 15px; align-items: stretch;">
                        <div style="flex: 1; display: flex; flex-direction: column; position: relative;">
                            <div style="flex: 1; display: flex; align-items: center; position: relative;">
                                ...
                                <input type="text" id="package_price_display" value="{{ old('package_price', $paku->package_price) }}" class="autocomplete-input" data-field="package_price" inputmode="numeric" placeholder="0" autocomplete="off" style="width: 100%; height: 100%; padding: 10px 70px 10px 38px; font-size: 14px;">
                        ...
                        <div style="display: flex; flex-direction: column; flex: 1; min-width: 0;">
                            ...
                            <div style="display: flex; align-items: center; position: relative;">
                                <div style="flex: 1; display: flex; align-items: center; position: relative;">
                                    <span class="price-prefix" style="position: absolute; left: 10px; font-size: 14px; font-weight: 600; color: #64748b; pointer-events: none; z-index: 1;">Rp</span>
                                    <input type="text" id="comparison_price_display" value="{{ old('comparison_price', $paku->comparison_price) }}" class="autocomplete-input" data-field="comparison_price" inputmode="numeric" placeholder="0" autocomplete="off" style="width: 100%; height: 38px; padding: 10px 72px 10px 38px; font-size: 14px;">
            ...
            <div class="image-section" style="display: flex; flex-direction: column; justify-content: space-between;">
                <div>
                    <div class="image-preview-box" id="photoPreviewArea" style="width: 100%; min-height: 200px; max-height: 400px; height: 320px; background-color: #ffffff; border: 2px dashed #e2e8f0; display: flex; align-items: center; justify-content: center; color: #cbd5e1; cursor: pointer; position: relative; overflow: hidden;">
                        <div id="photoPlaceholder" style="text-align: center; {{ $paku->photo_url ? 'display:none;' : '' }}">
                        ...
                        <img id="photoPreview" src="{{ $paku->photo_url ?? '' }}" alt="Preview" style="{{ $paku->photo_url ? 'display:block;' : 'display:none;' }} max-width: 100%; max-height: 100%; width: auto; height: auto; object-fit: contain;">
                    </div>
                    ...
                    <div class="image-actions" style="margin-top: 5px; display: flex; justify-content: center; font-weight: bold; font-size: 14px; padding: 0 10px; gap: 10px;">
                        ...
                        <span class="text-delete" id="deletePhotoBtn" style="color: #d9534f; cursor: pointer; {{ $paku->photo_url ? '' : 'display:none;' }}"><i class="bi bi-trash"></i> Hapus</span>
                    </div>
                </div>

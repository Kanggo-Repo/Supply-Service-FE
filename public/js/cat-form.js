function initCatForm() {
    ...
    function getFilterParams(field) {
        ...
        if (currentIndex > 0) {
            for (let i = 0; i < currentIndex; i++) {
                ...
                if (parentValue !== '') {
                    params.append(parentField, parentValue);
                }
            }
        }
    ...
    function buildSuggestionUrl(field, term = '') {
        ...
        if (field === 'store') {
            ...
            return `/api/stores/all-stores?search=${encodeURIComponent(term)}&limit=20`;
        }
        ...
        if (field === 'address') {
            ...
            if (storeInput && storeInput.value) {
                ...
                return `/api/stores/addresses-by-store?store=${encodeURIComponent(storeInput.value)}&search=${encodeURIComponent(term)}&limit=20`;
            }
